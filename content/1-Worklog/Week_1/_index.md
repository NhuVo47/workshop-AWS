...
- Create an AWS account and set up security methods such as MFA, IAM user management, and permissions
- Get familiar with AWS Management Console and CLI
- Propose and analyze product project requirements
